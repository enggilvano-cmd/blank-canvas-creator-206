-- Fix: Provisões abatendo valores em dobro
-- Problema: O trigger pode estar sendo disparado recursivamente quando atualiza a provisão
-- Solução: Adicionar verificação de profundidade do trigger
