-- Fix: Preservar transações concluídas COM badge "Fixa" na página Transações
-- Ao invés de deletar a transação pai, fazemos soft delete (is_fixed = false)
-- Isso mantém o parent_transaction_id das filhas intacto
