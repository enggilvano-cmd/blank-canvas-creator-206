-- Fix atomic_update_transaction para corrigir sinal do amount em transferências
-- Problema: Ao editar transferência, ambas as contas ficavam com saldo positivo
-- Solução: Inverter o sinal do amount da transação vinculada
