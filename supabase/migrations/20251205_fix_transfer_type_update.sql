-- Corrigir atomic_create_transfer para criar transações de saída com tipo 'transfer' em vez de 'expense'
-- Problema: A transação de saída estava sendo criada como 'expense', fazendo com que aparecesse nos totais de despesas
...
BEGIN
  ...
  -- ✅ CORREÇÃO: Criar transação de saída com tipo 'transfer' em vez de 'expense'
