-- Fix atomic_create_transfer return type to match Edge Function expectations
...
BEGIN
  ...
  -- Type: income (para ser compatível com filtros de frontend)
  -- Amount: Positivo
  -- Linked Transaction: Aponta para a saída
  INSERT INTO transactions (
    user_id, account_id, category_id, amount, type, 
